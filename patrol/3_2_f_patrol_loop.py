...
def main(args=None):
    ...
    # goal_pose.append(navigator.getPoseStamped([-0.61671, -0.852567], -1.02024))
    # goal_pose.append(navigator.getPoseStamped([0.0343325, -1.96793], 0.21976))
    # goal_pose.append(navigator.getPoseStamped([-0.711899, -0.0612125], 0.606873))

    goal_pose.append(navigator.getPoseStamped([-2.4402854442596436, 0.025683769956231117], TurtleBot4Directions.EAST))
    goal_pose.append(navigator.getPoseStamped([-2.1737616062164307, -2.751215696334839], TurtleBot4Directions.NORTH))
    goal_pose.append(navigator.getPoseStamped([-0.19662199914455414, -2.5783956050872803], TurtleBot4Directions.NORTH))
    goal_pose.append(navigator.getPoseStamped([-0.30392929911613464, -1.258741021156311], TurtleBot4Directions.NORTH))
    goal_pose.append(navigator.getPoseStamped([-0.6393863558769226, -1.9230144023895264], TurtleBot4Directions.NORTH))
    goal_pose.append(navigator.getPoseStamped([-1.4370911121368408, -2.0384979248046875], TurtleBot4Directions.NORTH))
    goal_pose.append(navigator.getPoseStamped([-1.4963725805282593, -1.9801025390625], TurtleBot4Directions.NORTH))
    goal_pose.append(navigator.getPoseStamped([-1.6304680109024048, -1.0010120868682861], TurtleBot4Directions.NORTH))
    goal_pose.append(navigator.getPoseStamped([-0.5553103685379028, -0.019219882786273956], TurtleBot4Directions.NORTH))
