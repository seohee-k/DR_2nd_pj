...
bool yolo_data__msg__monitored__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("yolo_data.msg._monitored.Monitored", full_classname_dest, 34) == 0);
  }
  yolo_data__msg__Monitored * ros_message = _ros_message;
  {  // class_name
...
{
  /* NOTE(esteve): Call constructor of Monitored */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("yolo_data.msg._monitored");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Monitored");
