...
static const _BoundingBoxes_type_support_symbol_names_t _BoundingBoxes_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, yoloinference, msg, BoundingBoxes)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, yoloinference, msg, BoundingBoxes)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, yoloinference, msg, BoundingBoxes)() {
  return &::yoloinference::msg::rosidl_typesupport_c::BoundingBoxes_message_type_support_handle;
}
