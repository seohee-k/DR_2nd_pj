...
static const _BoundingBoxes_type_support_symbol_names_t _BoundingBoxes_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, yoloinference, msg, BoundingBoxes)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, yoloinference, msg, BoundingBoxes)),
  }
};
...
{
  return &::yoloinference::msg::rosidl_typesupport_cpp::BoundingBoxes_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, yoloinference, msg, BoundingBoxes)() {
  return get_message_type_support_handle<yoloinference::msg::BoundingBoxes>();
}
