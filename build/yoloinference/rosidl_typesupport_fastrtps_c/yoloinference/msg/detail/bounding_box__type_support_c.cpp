...
#include "yoloinference/msg/detail/bounding_box__rosidl_typesupport_fastrtps_c.h"
...
using _BoundingBox__ros_msg_type = yoloinference__msg__BoundingBox;
...
static uint32_t _BoundingBox__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_yoloinference__msg__BoundingBox(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = yoloinference__msg__BoundingBox;
    is_plain =
      (
...
static size_t _BoundingBox__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_yoloinference__msg__BoundingBox(
