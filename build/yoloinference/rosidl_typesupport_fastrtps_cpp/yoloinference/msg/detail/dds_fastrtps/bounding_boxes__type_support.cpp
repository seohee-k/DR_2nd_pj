...
#include "yoloinference/msg/detail/bounding_boxes__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const yoloinference::msg::BoundingBox &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  yoloinference::msg::BoundingBox &);
size_t get_serialized_size(
  const yoloinference::msg::BoundingBox &,
  size_t current_alignment);
size_t
...
cdr_serialize(
  const yoloinference::msg::BoundingBoxes & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: boxes
  {
    ...
    for (size_t i = 0; i < size; i++) {
      yoloinference::msg::typesupport_fastrtps_cpp::cdr_serialize(
        ros_message.boxes[i],
        cdr);
    }
  }
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  yoloinference::msg::BoundingBoxes & ros_message)
{
  // Member: header
  ...
  // Member: boxes
  {
    ...
    for (size_t i = 0; i < size; i++) {
      yoloinference::msg::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  // Member: boxes
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        yoloinference::msg::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: boxes
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        yoloinference::msg::typesupport_fastrtps_cpp::max_serialized_size_BoundingBox(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = yoloinference::msg::BoundingBoxes;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const yoloinference::msg::BoundingBoxes *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<yoloinference::msg::BoundingBoxes *>(
    untyped_ros_message);
...
{
  return &yoloinference::msg::typesupport_fastrtps_cpp::_BoundingBoxes__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, yoloinference, msg, BoundingBoxes)() {
  return &yoloinference::msg::typesupport_fastrtps_cpp::_BoundingBoxes__handle;
}
