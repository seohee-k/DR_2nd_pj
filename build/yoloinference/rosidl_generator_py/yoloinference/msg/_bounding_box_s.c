...
bool yoloinference__msg__bounding_box__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("yoloinference.msg._bounding_box.BoundingBox", full_classname_dest, 43) == 0);
  }
  yoloinference__msg__BoundingBox * ros_message = _ros_message;
  {  // class_name
...
PyObject * yoloinference__msg__bounding_box__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("yoloinference.msg._bounding_box");
