...
class Metaclass_BoundingBoxes(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('yoloinference')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'yoloinference.msg.BoundingBoxes')
            logger.debug(
            ...
            from yoloinference.msg import BoundingBox
...
class BoundingBoxes(metaclass=Metaclass_BoundingBoxes):
    ...
    _fields_and_field_types = {
        ...
        'boxes': 'sequence<yoloinference/BoundingBox>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['std_msgs', 'msg'], 'Header'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['yoloinference', 'msg'], 'BoundingBox')),  # noqa: E501
    )
